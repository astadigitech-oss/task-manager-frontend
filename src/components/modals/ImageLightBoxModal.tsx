  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        {/* HEADER SECTION */}
        <div className="absolute top-0 left-0 right-0 z-50 flex items-center justify-between p-6 bg-transparent">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              ...
              className={allowDownload ? "overlay-btn" : "text-foreground cursor-not-allowed opacity-50 h-9 w-9"}
        ...
        {/* THUMBNAILS SECTION */}
        {images.length > 1 && (
          <div className="absolute bottom-0 left-0 right-0 z-50 p-6 bg-transparent">
